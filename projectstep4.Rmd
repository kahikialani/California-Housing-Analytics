---
title: "California Housing Analytics Project, Phase 4"
...
```{r plot, echo= FALSE, comment = NULL, out.width="50%", fig.align="center", fig.show='hold', fig.cap="Comparison of Models: MLR, RR, and LASSO"}
